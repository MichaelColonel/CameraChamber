...
{
  Q_DECLARE_PUBLIC(FullCamera3);
protected:
  FullCamera3* const q_ptr;
public:
  FullCamera3Private(FullCamera3 &object);
...
FullCamera3Private::~FullCamera3Private()
{
}

FullCamera3::FullCamera3(const AbstractCamera::CameraDeviceData& data, QObject *parent)
  :
  FullCamera(data, parent),
  d_ptr(new FullCamera3Private(*this))
{
  Q_D(FullCamera3);
}

FullCamera3::~FullCamera3()
{
...
TH2* FullCamera3::createProfile2D(bool integral)
{
  Q_D(FullCamera3);
...
void FullCamera3::updateProfiles2D(TH2* pseudo2D, TH2* integPseudo2D)
{
  Q_D(FullCamera3);
